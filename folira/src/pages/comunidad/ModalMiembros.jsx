...
const ModalMiembrosComunidad = ({ miembros }) => {
  ...
  {isOpen && (
    <>
      {/* Fondo negro semi-transparente detrás del modal */}
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50" onClick={toggleModal}></div>
