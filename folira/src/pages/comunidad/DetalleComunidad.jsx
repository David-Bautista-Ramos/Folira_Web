...
const DetallesComunidad = ({ comunidad }) => {
  ...
  return (
    <div className='flex-[4_4_0] mr-auto border-r border-blue-700 min-h-screen overflow-auto'>
      <div className="flex flex-col p-6 bg-black rounded-lg shadow-lg relative -mt-[100px] ml-[-10px] mr-[20px]">
       <button>
        hola
       </button>
        <div className="flex">
