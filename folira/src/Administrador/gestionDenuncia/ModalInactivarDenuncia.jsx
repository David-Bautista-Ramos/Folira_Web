const ModalInactivarDenuncia = ({ isOpen, onClose, denuncia, onConfirm }) => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-5 w-96">
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-lg font-semibold">Inactivar Denuncia</h2>
                ...
                <div className="flex justify-end gap-4 mt-4">
                    ...
                    <button
                        ...
                        onClick={() => {
                            onConfirm(denuncia); // Llama a la función de confirmación
