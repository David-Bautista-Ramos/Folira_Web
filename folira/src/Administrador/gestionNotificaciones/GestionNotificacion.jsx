...
import { BiHeart, BiPowerOff, BiReset, BiPlus, BiEdit, BiHide, BiShow } from "react-icons/bi";
            ...
            <div className="flex flex-wrap justify-center gap-10 p-2">
                {publicaciones.map((libro) => {
                    ...
                    <div key={libro._id} className="bg-white shadow-lg rounded-lg w-[320px] p-2 mb-4 border border-gray-300 flex flex-col">
                        ...
                        {/* Botón "Ver más" / "Ver menos" - Justo debajo del texto */}
                        <button
                        ...
                        {/* Sección de íconos y botones - Siempre en la parte inferior */}
