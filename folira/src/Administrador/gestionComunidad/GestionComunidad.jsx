    ...
    const handleFilter = async (filter) => {
      ...
      try {
        ...
        if (data && Array.isArray(data)) {
          ...
          console.error("La respuesta no contiene un array de comunidades:", data);
        }
      } catch (error) {
            ...
            <div>
                <main className="bg-white w-[100%] max-w-[1600px] mx-4 mt-20 rounded-t-2xl border border-gray-500 shadow-lg">
                    ...
                    <div className="flex flex-wrap justify-center gap-6 p-6">
                        {isLoading ? (
                        ...
                        ) : Array.isArray(filteredComunidad) && filteredComunidad.length > 0 ? (
                            ...
                            >
                                ...
                                <div className="w-24 h-24 bg-gray-300 rounded-full border border-primary overflow-hidden mr-4">
                                    ...
                                    src={comunidad.fotoComunidad || "url_de_la_imagen_usuario"} // Usa la foto del usuario
                                    alt="Usuario"
                                    />
                                </div>
                                <div className="relative">x
                                    <div className="mb-1">
                                    <h2 className="font-semibold">Nombre: {comunidad.nombre}</h2>
                                    </div>
